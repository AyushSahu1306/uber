    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center p-4 md:p-8">
      <div className="max-w-6xl w-full">
          ...
          >
            <Card className="border-2 hover:border-black dark:hover:border-white transition-all duration-300 overflow-hidden h-full">
              <CardHeader className="pb-2">
                ...
                <CardDescription>Register to book rides and manage your trips</CardDescription>
              </CardHeader>
          ...
          >
            <Card className="border-2 hover:border-black dark:hover:border-white transition-all duration-300 overflow-hidden h-full">
              <CardHeader className="pb-2">
                ...
                <CardDescription>Register to accept rides and manage your earnings</CardDescription>
              </CardHeader>
        ...
        <div className="text-center mt-8 text-sm text-gray-500 dark:text-gray-400">
          <p>Already have an Account <a href="/login" className="font-medium underline underline-offset-4 hover:text-black dark:hover:text-white">Login</a></p>
        </div>
      </div>
    </div>
  )
